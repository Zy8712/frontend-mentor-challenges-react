...
const GenerateAdviceBlock = () => {
    ...
    return (
        <>
            <div className="react-gen-custom-container rounded-2xl h-80 flex flex-col justify-center items-center">
                <div className="w-full h-full mt-8 mr-6 mb-8 ml-6 text-center relative flex flex-col justify-center items-center">
                    <h2 className="absolute top-0 left-0 right-0 m-auto text-xs uppercase react-gen-advice-header-custom">Advice #{adviceID}</h2>
                    <h1 className="h-2/3 ml-2 mr-2 react-gen-advice-quote-custom">"{adviceText}"</h1>
